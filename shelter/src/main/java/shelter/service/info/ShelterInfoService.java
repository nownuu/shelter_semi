...
public class ShelterInfoService {
    ...
    public String getShelterInfo() {
        try {
            ...
            if (responseCode == HttpURLConnection.HTTP_OK) {
                ...
                return "Error: HTTP GET request failed with response code " + responseCode;
            }
        } catch (IOException e) {
            e.printStackTrace();
    ...
    public static void main(String[] args) {
        ...
        String result = shelterInfoService.getShelterInfo();
        System.out.println("ShelterInfoService Result: " + result);
    }
}